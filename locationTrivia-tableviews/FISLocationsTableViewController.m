...
//
//  Created by Eldon Chan on 6/23/16.
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FISLocation *itemAtLocation = self.locations[indexPath.row];
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    FISLocation *itemAtLocation = self.locations[index];

    triviaVC.trivia = itemAtLocation.trivia;
